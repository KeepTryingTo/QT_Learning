...
SOURCES += \
    main.cpp \
    sdlffmpegvideoplayer.cpp

HEADERS += \
    sdlffmpegvideoplayer.h

FORMS += \
    sdlffmpegvideoplayer.ui
...
win32:CONFIG(release, debug|release): LIBS += -L$$PWD/../../../SDL2-2.30.6/x86_64-w64-mingw32/lib/ -llibSDL2.dll \
                                                -llibSDL2_ttf.dll -llibSDL2_image.dll -llibSDL2_mixer.dll
...
win32:CONFIG(release, debug|release): LIBS += -L$$PWD/../../../SDL2-2.30.6/x86_64-w64-mingw32/bin/ -lSDL2.dll \
                                                -lSDL2_ttf.dll -lSDL2_image.dll -lSDL2_mixer.dll
